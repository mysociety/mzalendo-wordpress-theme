    ...
    <div class="site-footer__links__secondary">
        <ul>
            <li>
                ...
                <a href="https://www.facebook.com/sharer/sharer.php?u=http://info.mzalendo.com/template-for-blog.html" target="_blank">
                    Share this page
                </a>
            </li>
            <li>
                <a href="https://twitter.com/MzalendoWatch">Twitter</a> –
                <a href="https://twitter.com/share?via=MzalendoWatch&amp;url=http://info.mzalendo.com/template-for-blog.html" target="_blank">
                    Share this page
                </a>
            </li>
            <li>
        ...
        <ul>
            ...
            <li><a href="http://info.mzalendo.com/feedback/" class="feedback_link"><strong>Give us feedback</strong></a></li>
        </ul>
    </div>
</div>
...
<div class="site-footer__attribution">
    <p>
        ...
        written by <a href="http://www.mysociety.org">mySociety</a>.
          ...
          <script type="text/javascript" src="http://info.mzalendo.com/static/js/base.8b114435d459.js" charset="utf-8"></script>
          <script type="text/javascript" src="http://info.mzalendo.com/static/js/survey.43dfe252a049.js" charset="utf-8"></script>
